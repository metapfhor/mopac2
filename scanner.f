     ...
     1                  VALS, NVALS
      ...
      DOUBLE PRECISION VALS(3*NUMATM),ATOT(3,3),GEO(3,NUMATM),TMP
      IF(NDIM.GT.0)THEN

      IF(ABS(GEO(IVALS(2,1),IVALS(1,1))-LIMS(1)).LT.
     1   ABS(STEPS(1)/2.D0))THEN
      DO I=1,NDIM
      IF(ABS(GEO(IVALS(2,I),IVALS(1,I))-LIMS(I)).LT.
...
C       AXES
  ...
  403 CONTINUE
     ...
     1          ,FILEI,FILEN,LENGTH(80),ANGLES(80),DIHDRL(80),ATOMS(80)
      LOGICAL APPLIED,PRMTD,REDSCN
      DOUBLE PRECISION VALS(3*NUMATM),ATOT(3,3),XYZ(3,NUMATM)
